...
namespace LifeSamadhan.API.Migrations
{
    ...
    [Migration("20260130200243_AddRazorpayTrackingToPayment")]
    partial class AddRazorpayTrackingToPayment
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LifeSamadhan.API.Models.Rating", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("LifeSamadhan.API.Models.Rating", b =>
                {
                    b.HasOne("LifeSamadhan.API.Models.User", "Reviewee")
                        .WithMany()
                        .HasForeignKey("RevieweeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LifeSamadhan.API.Models.User", "Reviewer")
                        .WithMany()
                        .HasForeignKey("ReviewerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LifeSamadhan.API.Models.ServiceRequest", "ServiceRequest")
                        .WithMany()
            ...
            modelBuilder.Entity("LifeSamadhan.API.Models.ServiceRequest", b =>
                {
                    b.HasOne("LifeSamadhan.API.Models.User", "Customer")
                        .WithMany()
